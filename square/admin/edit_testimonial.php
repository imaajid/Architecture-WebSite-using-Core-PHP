...
$id = $_GET['id'];
$records = mysqli_query($conn,"SELECT * FROM testimonial where id = '$id'");
...
if(isset($_POST['submit']))
{
    ...
    if(isset($_FILES["image"]))
    {
        ...
        $edit = mysqli_query($conn," UPDATE testimonial set id ='$id', name ='$name',message='$message',designation='$designation',image='$fileName' where id='$id'");


    }
    else{

        $edit = mysqli_query($conn," UPDATE testimonial set id ='$id', name ='$name',message='$message',designation='$designation' where id='$id'");
    }
    ...
    if($edit)
    {
        ...
        header("location:list_testimonial.php"); // redirects to all records page
        exit;
    }
    else
    {
