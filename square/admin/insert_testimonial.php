...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO testimonial(name,message,designation,image)VALUES ('" . $_POST["name"] . "','" . $_POST["message"] . "','" . $_POST["designation"] . "','" . $fileName ."')";
        ...
        <div class="card-body">
            <form action="" method="post" action="" enctype='multipart/form-data'>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="message" id="example-tel-input">
                </div>
                <div class="form-group">
                    <label for="example-email-input" class="col-form-label">designation</label>
                    <input class="form-control" type="text" name="designation" id="example-email-input">
                </div>
                <div class="form-group">
