...
if (isset($_POST['submit'])) {
    ...
    $collection_name = $usertype;
    $request_url = $url . '/' . $collection_name . '/' . $userid;
                ...
                <div class="login-form-body">
                    ...
                    <form method="post">
                        <div class="form-gp">
                            ...
                            <input type="number" id="exampleInputEmail1" name="user_id" required>
                            <i class="ti-email"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="InputPassword1">Password</label>
                            <input type="password" id="InputPassword1" name="password" required>
                            <i class="ti-lock"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" name="submit" type="submit">Submit <i class="ti-arrow-right"></i>
                            </button>
                        </div>
                    </form>
